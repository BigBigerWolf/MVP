...
public abstract class AnimatorAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    /**
     * Saved instance state key for the ViewAnimatorAdapter
     */
    private static final String SAVEDINSTANCESTATE_VIEWANIMATOR = "savedinstancestate_viewanimator";

    /**
     * The ViewAnimatorAdapter responsible for animating the Views.
     */
    @Nullable
    private ViewAnimatorAdapter mViewAnimator;
    ...
    public AnimatorAdapter(RecyclerView.Adapter<T> adapter, RecyclerView recyclerView) {
        mAdapter = adapter;
        mViewAnimator = new ViewAnimatorAdapter(recyclerView);
    ...
    private void animateView(final View view, final int position) {
        ...
        mViewAnimator.animateViewIfNecessary(getItemCount(), position, view, concatAnimators);
    }
    ...
    @Nullable
    public ViewAnimatorAdapter getViewAnimator() {
