...
public class ViewAnimatorAdapter {
    ...
    /**
     * Creates a new ViewAnimatorAdapter, using the given {@link RecyclerView}.
     *
     * @param recyclerView the {@code ListViewWrapper} which wraps the implementation of the ListView used.
     */
    public ViewAnimatorAdapter(@NonNull final RecyclerView recyclerView) {
     ...
     */
    public void animateViewIfNecessary(final int itemCount, int position, @NonNull final View view, @NonNull final Animator[] animators) {
    ...
    private int calculateAnimationDelay(final int position) {
        ...
        if (mRecyclerView.getLayoutManager() instanceof LinearLayoutManager) {
            lastVisiblePosition = ((LinearLayoutManager) mRecyclerView.getLayoutManager()).findLastCompletelyVisibleItemPosition();
            firstVisiblePosition = ((LinearLayoutManager) mRecyclerView.getLayoutManager()).findFirstCompletelyVisibleItemPosition();
